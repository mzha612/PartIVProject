...
% Check that the vessel radius is greater than the EGL thickness
if H <= epsilon_true
    error_txt = sprintf(...
...
length_factor = 10; % length_factor * vessel radius = length of the vessel
...
resistance = abs(P*A*length_factor)./flow_rate;
